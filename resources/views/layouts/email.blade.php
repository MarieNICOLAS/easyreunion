            ...
            <div role="banner">
                <div class="preheader"
                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;">
                        ...
                        <div class="snippet"
                             style="display: table-cell;Float: left;font-size: 12px;line-height: 19px;max-width: 280px;min-width: 140px; width: 140px;width: calc(14000% - 78120px);padding: 10px 0 5px 0;color: #999;font-family: Times,Times New Roman,serif;">
                ...
                <div class="header"
                    ...
                    <div class="logo emb-logo-margin-box"
                         style="font-size: 26px;line-height: 32px;Margin-top: 16px;Margin-bottom: 24px;color: #41637e;font-family: Times,Times New Roman,serif;Margin-left: 20px;Margin-right: 20px;"
                         align="center">
                        <div class="logo-left" align="left" id="emb-email-header"><a
                                style="text-decoration: none;transition: opacity 0.1s ease-in;color: #41637e;"
                            ><img
                                    style="display: block;height: auto;width: 100%;border: 0;max-width: 300px;"
                                    src="https://easyreunion.fr/images/logo/new-logo-xs.png" alt="Easy reunion logo"
                                    width="300"></a></div>
                    </div>
                    <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
                </div>
            ...
            <div>
                <div class="layout one-col fixed-width stack"
                    ...
                    <div class="layout__inner"
                        ...
                        <div class="column"
                             style="text-align: left;color: #717a8a;font-size: 16px;line-height: 24px;font-family: Times,Times New Roman,serif;">
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;line-height: 16px;font-size: 1px;">&nbsp;
                                </div>
                            </div>
                            ...
                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
                                    <p style="Margin-top: 0;Margin-bottom: 20px;">{{ __('auth.email_best') }}<br>
                                        Easy Réunion</p>
                                </div>
                            </div>

                            <div style="Margin-left: 20px;Margin-right: 20px;">
                                <div style="mso-line-height-rule: exactly;line-height: 24px;font-size: 1px;">&nbsp;
                                </div>
                            </div>
                            ...
                            <div style="font-size: 12px;font-style: normal;font-weight: normal;line-height: 19px;"
                                ...
                                <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-bottom"
                                     style="border: 0;display: block;height: auto;width: 100%;max-width: 900px;" alt=""
                                     width="600"
                                     src="https://i1.createsend1.com/ei/y/D9/AA1/CE9/214938/csfinal/divider-1px3-9900000000079e3c.png">
                            </div>
            ...
            <div role="contentinfo">
                ...
                <div class="layout email-flexible-footer email-footer"
                    ...
                    <div class="layout__inner left-aligned-footer"
                        ...
                        <td valign="top"><![endif]-->
                        <div class="column"
                             style="text-align: left;font-size: 12px;line-height: 19px;color: #999;font-family: Times,Times New Roman,serif;">
                            <div class="footer-logo emb-logo-margin-box"
                                 style="font-size: 26px;line-height: 32px;Margin-top: 16px;Margin-bottom: 24px;color: #7b663d;font-family: Roboto,Tahoma,sans-serif;"
                                 align="center">
                                <div style="margin-right: 20px;" emb-flexible-footer-logo align="center"><img
                                        style="border: 0;display: block;height: auto;width: 100%;max-width: 180px;"
                                        src="https://easyreunion.fr/images/logo/logo-small.png"
                                        alt="" width="180"></div>
                            </div>
                        </div>
                        <!--[if (mso)|(IE)]></td><![endif]-->
                        ...
                        <td valign="top"><![endif]-->
                        <div class="column"
                             style="text-align: left;font-size: 12px;line-height: 19px;color: #999;font-family: Times,Times New Roman,serif;display: none;">
                        ...
                        <!--[if (mso)|(IE)]>
                        <td valign="top"><![endif]-->
                        <table style="border-collapse: collapse;table-layout: fixed;display: inline-block;width: 400px;"
                               cellpadding="0" cellspacing="0">
                            <tbody>
                            <tr>
                                <td>
                                    <div class="column js-footer-additional-info"
                                         style="text-align: left;font-size: 12px;line-height: 19px;color: #999;font-family: Times,Times New Roman,serif;width: 400px;">
                                        <div
